...
class M2E_e2M_Helper_eBay_Inventory {
    ...
    private $marketplaceTitles = array(
        M2E_e2M_Helper_Item::MARKETPLACE_CUSTOM_CODE_ID => self::MARKETPLACE_CUSTOM_CODE_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_AU_ID => self::MARKETPLACE_AU_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_AT_ID => self::MARKETPLACE_AT_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_BE_DU_ID => self::MARKETPLACE_BE_DU_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_BE_FR_ID => self::MARKETPLACE_BE_FR_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_CA_ID => self::MARKETPLACE_CA_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_CA_FR_ID => self::MARKETPLACE_CA_FR_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_MOTORS_ID => self::MARKETPLACE_MOTORS_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_FR_ID => self::MARKETPLACE_FR_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_DE_ID => self::MARKETPLACE_DE_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_HK_ID => self::MARKETPLACE_HK_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_IN_ID => self::MARKETPLACE_IN_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_IE_ID => self::MARKETPLACE_IE_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_IT_ID => self::MARKETPLACE_IT_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_MY_ID => self::MARKETPLACE_MY_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_NL_ID => self::MARKETPLACE_NL_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_PH_ID => self::MARKETPLACE_PH_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_PL_ID => self::MARKETPLACE_PL_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_RU_ID => self::MARKETPLACE_RU_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_SG_ID => self::MARKETPLACE_SG_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_SP_ID => self::MARKETPLACE_SP_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_CH_ID => self::MARKETPLACE_CH_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_UK_ID => self::MARKETPLACE_UK_TITLE,
        M2E_e2M_Helper_Item::MARKETPLACE_US_ID => self::MARKETPLACE_US_TITLE
    );
