...
class M2E_e2M_Model_Cron_Task_Completed implements M2E_e2M_Model_Cron_Task {
    ...
    public function process($data) {
        ...
        if ($progressHelper->isCompletedProgressByTag(M2E_e2M_Helper_Data::EBAY_DOWNLOAD_INVENTORY)) {
        ...
        if ($progressHelper->isCompletedProgressByTag(M2E_e2M_Helper_Data::MAGENTO_IMPORT_INVENTORY)) {
            $connWrite->delete($cronTasksInProcessingTableName, array(
