...
class M2e_M2i_Adminhtml_M2iController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->getLayout()->getBlock('head')->addJs('eM2/eBay/UrlHandler.js');
        $this->getLayout()->getBlock('head')->addJs('eM2/eBay/AccountHandler.js');

        $this->_addContent($this->getLayout()->createBlock('m2i/adminhtml_main'));
        $this->_setActiveMenu('m2i');
        $this->renderLayout();
    }
    ...
    public function beforeGetTokenAction() {
        ...
        try {
            ...
            /** @var M2e_M2i_Model_Api_Ebay $eBayAPI */
            $eBayAPI = Mage::getModel('m2i/Api_Ebay');
            ...
            $authURL = $eBayAPI->getAuthURL($this->getUrl('*/m2i/afterGetToken'), $sessionID);
    ...
    public function startDownloadInventoryAction() {
        ...
        try {
            ...
            $count = $connWrite->select()->from($m2eM2iInventory, 'COUNT(*)')->query()->fetchColumn();
